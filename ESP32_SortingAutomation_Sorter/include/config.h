...
namespace CH {
  ...
  // GPB0(ch8), AIN1 di GPB1(ch9). Nilai di bawah SUDAH disesuaikan (bukan lagi urutan default
  // pinout awal) supaya CH::AIN1 software = pin AIN1 fisik TB6612 yang sebenarnya.
